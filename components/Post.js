...
import { addDoc, serverTimestamp, collection, onSnapshot, orderBy, query, setDoc, doc, deleteDoc } from "@firebase/firestore";
        ...
        <div className="bg-white my-7 border rounded-sm">
            ...
            {session && (
                ...
                <div className="flex space-x-4">
                    {
                        hasLiked ? (
                            <HearthIconFilled onClick={likePost} className="btn text-red-500" />
                        ) : (
